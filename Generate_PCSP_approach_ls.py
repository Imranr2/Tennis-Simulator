...
from generate_pcsp_helpers_approach_ls.get_params import get_params
...
# generate pcsp file
def generate_pcsp_approach_ls(data, date, ply1_name, ply2_name, ply1_hand, ply2_hand, pcsp_filename):
    params = get_params(
        data, date, ply1_name, ply2_name, ply1_hand, ply2_hand
    )
    VAR = 'generate_pcsp_helpers_approach_ls/var.txt'
    HAND = 'generate_pcsp_helpers_approach_ls/%s_%s.txt' % (ply1_hand, ply2_hand)
