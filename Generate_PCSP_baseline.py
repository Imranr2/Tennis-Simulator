...
from generate_pcsp_helpers_baseline.get_params import get_params
...
# generate pcsp file
def generate_pcsp_baseline(data, date, ply1_name, ply2_name, ply1_hand, ply2_hand, pcsp_filename):
    params = get_params(
        data, date, ply1_name, ply2_name, ply1_hand, ply2_hand
    )
    VAR = 'generate_pcsp_helpers_baseline/var.txt'
    HAND = 'generate_pcsp_helpers_baseline/%s_%s.txt' % (ply1_hand, ply2_hand)
