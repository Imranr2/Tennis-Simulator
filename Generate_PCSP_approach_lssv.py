...
from generate_pcsp_helpers_approach_lssv.get_params import get_params
...
# generate pcsp file
def generate_pcsp_approach_lssv(data, date, ply1_name, ply2_name, ply1_hand, ply2_hand, pcsp_filename):
    params = get_params(
        data, date, ply1_name, ply2_name, ply1_hand, ply2_hand
    )
    VAR = 'generate_pcsp_helpers_approach_lssv/var.txt'
    HAND = 'generate_pcsp_helpers_approach_lssv/%s_%s.txt' % (ply1_hand, ply2_hand)
